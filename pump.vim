...
set laststatus=2
set ruler
set runtimepath=~/.vim,~/.vim/pack/tpope/start/fugitive,~/.vim/plugged/emmet-vim,~/.vim/plugged/vim-prettier,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/auto-pairs,~/.vim/plugged/gruvbox,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-fugitive,~/.vim/plugged/bracey.vim,~/.vim/plugged/nerdtree-git-plugin,~/.vim/plugged/vim-rest-console,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/nerdtree-git-plugin/after,~/.vim/after
set splitbelow
set splitright
...
silent only
silent tabonly
cd ~/.scripts/arduino_esp/pumpapi
...
badd +7 pump.html
badd +16 pump.js
badd +214 pumpapi.ino
badd +0 pump.css
badd +0 wsServer.js
badd +0 ../index.js
badd +4 ~/.scripts/arduino_esp/scheduler/index.js
argglobal
%argdel
$argadd pump.html
set stal=2
...
silent! normal! zE
let &fdl = &fdl
let s:l = 150 - ((34 * winheight(0) + 28) / 57)
...
wincmd w
argglobal
terminal ++curwin ++cols=106 ++rows=28 
let s:term_buf_20 = bufnr()
balt wsServer.js
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
silent! normal! zE
let &fdl = &fdl
let s:l = 18 - ((5 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 18
...
silent! normal! zE
let &fdl = &fdl
let s:l = 31 - ((14 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
normal! 012|
tabnext
edit ~/.scripts/arduino_esp/scheduler/index.js
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
argglobal
terminal ++curwin ++cols=106 ++rows=28 
let s:term_buf_24 = bufnr()
balt ~/.scripts/arduino_esp/scheduler/index.js
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
